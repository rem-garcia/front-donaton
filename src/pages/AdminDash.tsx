...
const donaciones: Donacion[] = [
  ...
  {
    id: 3, tipo: 'Agua', cantidad: 200, unidad: 'litros', origen: 'Aguas Andinas', estado: 'ASIGNADA', fechaCreacion: '2026-06-17', usuarioId: 2,
    necesidadId: 0,
    centroAcopioId: 0
  },
  {
...
const usuarios = [
  { id: 1, nombre: 'Admin Demo',      rol: 'ADMIN' },
  { id: 2, nombre: 'Carla Coord.',    rol: 'COORDINADOR' },
  { id: 3, nombre: 'Pedro Voluntario', rol: 'VOLUNTARIO' },
]
      ...
      <div className="max-w-6xl mx-auto flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="text-gray-500 text-sm">
            Vista general del sistema y accesos a la gestión.
          </p>
        </div>
